...
-- select ((upper((substring(FIRST_NAME,1,1)))+SUBSTRING(first_name,2,len(first_name)-1))) as  FIRST_NAME,((upper((substring(lasT_NAME,1,1)))+SUBSTRING(last_name,2,len(last_name)-1))) as  FIRST_NAME from employees;
...
-- select first_name, dateadd(month,1,hire_date) from employees;

-- select first_name,dateDIFF( year, HIRE_DATE,getdate() ) from employees;
